...
### Remediation
- **Status:** deny
- **Summary:** Denied by policy (policy\_unavailable\_fail\_closed). No patch generated.
- **Approach:** Policy gate denied automated patching; guidance-only — a human must remediate.
...
### Remediation
- **Status:** skipped
- **Summary:** finding not processed for remediation
...
## Remediation Summary
- Total findings (true positive): 5
- Findings in scope for remediation: 5
- Remediated: 0
- Success Rate(remediated/true positive): 0%
